...
my $staging_dbh = DBI->connect("dbi:mysql:database=tmp_leads;host=192.168.48.21;port=3306", "dannyf", "Truesl1des");
my $production_dbh = DBI->connect("dbi:mysql:database=leads;host=localhost;port=3306", "dannyf", "Truesl1des");
